...
static int cros_ec_i2c_test_init(struct kunit *test)
{
	...
	kunit_activate_kprobe_stub(test, cros_ec_register, fake_cros_ec_register);
	kunit_activate_kprobe_stub(test, cros_ec_unregister, fake_cros_ec_unregister);
...
static void cros_ec_i2c_test_exit(struct kunit *test)
{
	...
	kunit_deactivate_kprobe_stub(test, cros_ec_register);
	kunit_deactivate_kprobe_stub(test, cros_ec_unregister);
}
